...
from util.data import RedditDataset, Dataset
from util.model import AutoModelForSentenceEmbedding
...
if __name__ == "__main__":
    ...
    parser.add_argument('--stack_overflow_body_folder',
                        default="./data/stackexchange_titlebody_best_voted_answer_jsonl")
