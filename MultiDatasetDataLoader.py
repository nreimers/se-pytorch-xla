...
class MultiDatasetDataLoader(DataLoader):
    def __init__(self, datasets, batch_size_pairs, batch_size_triplets=None, dataset_size_temp=-1, allow_swap=True, random_batch_fraction=0, dataloader_len=None, collate_fn=None):
        #super(MultiDatasetDataLoader).__init__()
        ...
        self.dataset = []   #Needed for accelerate
    ...
    def __len__(self):
        if self.dataloader_len is not None:
